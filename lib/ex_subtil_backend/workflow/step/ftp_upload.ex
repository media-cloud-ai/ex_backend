defmodule ExSubtilBackend.Workflow.Step.FtpUpload do
  ...
  defp start_upload([], _workflow), do: {:ok, "started"}
  defp start_upload([file | files], workflow) do
    ...
    current_date =
      Timex.local
      |> Timex.format!("%Y_%m_%d__%H_%M", :strftime)
