defmodule ExSubtilBackend.Amqp.JobAcsErrorConsumer do
  ...
  def consume(
    ...
    description = get_error_description(error_code, description)
    do_consume(channel, tag, job_id, %{code: error_code, message: description})
  end
  ...
  defp get_error_description(error_code, description) do
    case error_code do
