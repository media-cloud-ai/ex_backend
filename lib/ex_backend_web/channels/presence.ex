defmodule ExBackendWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule ExBackend.MyChannel do
        use ExBackendWeb, :channel
        alias ExBackend.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :ex_backend,
