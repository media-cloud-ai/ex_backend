    ...
    %{
      User: swagger_schema do
        ...
        properties do
          ...
          secret_access_key :string, "API Secret access key (only present when generating credentials)"
        end
        example %{
      ...
      ValidationLink: swagger_schema do
