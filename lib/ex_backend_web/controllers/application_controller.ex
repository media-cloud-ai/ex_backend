 defmodule ExBackendWeb.ApplicationController do
  ...
  def index(conn, _params) do
    identifier = System.get_env("APP_IDENTIFIER") || Application.get_env(:ex_backend, :app_identifier)
    ...
    company_logo = System.get_env("APP_COMPANY_LOGO") || Application.get_env(:ex_backend, :app_company_logo)
