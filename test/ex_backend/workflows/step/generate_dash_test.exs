        ...
        %Job{
          ...
          parameters: [
            %{
              "id" => "destination_path",
              "type" => "string",
              "value" => "/2018/S12/J7/173535163-5ab81c23a3594-standard3.mp4"
            }
          ]
        }
      ]
        ...
        %Job{
          ...
          parameters: [
            %{
              "id" => "destination_path",
              "type" => "string",
              "value" => "/2018/S12/J7/173535163-5ab81c23a3594-standard1.mp4"
            }
          ]
        },
        %Job{
          ...
          parameters: [
            %{
              ...
              "type" => "array_of_strings",
              "value" => ["/2018/S12/J7/173535163-5ab81c23a3594-fra.mp4"]
            }
          ]
        }
      ]
        ...
        %Job{
          ...
          parameters: [
            %{
              "id" => "destination_path",
              "type" => "string",
              "value" => "/2018/S12/J7/173535163-5ab81c23a3594-qad.mp4"
            }
          ]
        },
        %Job{
        ...
        %Job{
          ...
          parameters: [
            %{
              "id" => "destination_path",
              "type" => "string",
              "value" => "/2018/S12/J7/173535163-5ab81c23a3594-qaa.mp4"
            }
          ]
        },
        %Job{
